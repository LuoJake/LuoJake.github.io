...
function parsePost(filename) {
  ...
  return { id: path.basename(filename, ".md"), ...data, date, tags: Array.isArray(data.tags) ? data.tags : [data.tags], featured: Boolean(data.featured), body: match[2].trim() };
}
...
console.log(`Built ${posts.length} posts and ${daily.quotes.length} daily quotes into dist/.`);
