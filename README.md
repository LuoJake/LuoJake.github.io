...
一个部署在 GitHub Pages 上的个人文字库，包含阅读、搜索、可点击标签归档、人物与书籍资料库、文章详情、每日自省、跨设备内容管理、本地可视化写作台、标签推荐和 PDF/文本摘录发现。
...
- 人物与书籍位于 `content/sources.yml`，文章通过 `relatedSources` 与资料页关联。
...
- PDF、TXT 和 Markdown 文件可以在本机写作台中读取；PDF.js 只在浏览器本地提取文字，智能筛选最多 50 条短句候选，由使用者勾选后存为草稿。
